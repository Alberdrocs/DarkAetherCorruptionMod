...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        fenceItem(ModBlocks.AETHER_STONE_FENCE, ModBlocks.AETHER_STONE_BRICKS);
        wallItem(ModBlocks.AETHER_STONE_WALL, ModBlocks.AETHER_STONE_BRICKS);

        evenSimplerBlockItem(ModBlocks.AETHER_STONE_STAIRS);
        ...
        saplingItem(ModBlocks.CORRUPTED_DARK_OAK_SAPLING);
        saplingItem(ModBlocks.CORRUPTED_BIRCH_SAPLING);
        saplingItem(ModBlocks.CORRUPTED_ACACIA_SAPLING);
        saplingItem(ModBlocks.CORRUPTED_SPRUCE_SAPLING);
        saplingItem(ModBlocks.CORRUPTED_CHERRY_SAPLING);
        saplingItem(ModBlocks.CORRUPTED_MANGROVE_PROPAGULE);
    ...
    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(DarkAetherCorruptionMod.MOD_ID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
    ...
    public void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/fence_inventory"))
                .texture("texture",  new ResourceLocation(DarkAetherCorruptionMod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
    ...
    public void wallItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/wall_inventory"))
                .texture("wall",  new ResourceLocation(DarkAetherCorruptionMod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
